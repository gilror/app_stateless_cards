...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
        ...
        theme: ThemeData(
            // primarySwatch: Color.fromARGB(255, 105, 136, 151),
            ),
        home: const HomePage());
  }
}
            ...
            children: <Widget>[
              Column(
                ...
                children: <Widget>[
                  MyCard(
                    ...
                    nombre: const Text("Nombre: Gilberto Rodríguez Ramírez",
                        style: TextStyle(color: Colors.black, fontSize: 15.0)),
                    genero: const Text("Genero: Masculino",
                        style: TextStyle(color: Colors.black, fontSize: 15.0)),
                    edad: const Text("Edad: 31 años",
                        style: TextStyle(color: Colors.black, fontSize: 15.0)),
                    correo: const Text(
                        "Email: gilberto.rodriguezramirez@utxicotepec.edu.mx",
                        style: TextStyle(color: Colors.black, fontSize: 15.0)),
                    matricula: const Text("Matricula:191004",
                        style: TextStyle(color: Colors.black, fontSize: 15.0)),
                  ),
                ],
              ),
              MyCard(
                ...
                correo: const Text("Grupo: B ",
                    style: TextStyle(color: Colors.black, fontSize: 15.0)),
                matricula: const Text("Modalidad: Semi Escolarizado",
                    style: TextStyle(color: Colors.black, fontSize: 15.0)),
              ),
              DataTable(
                sortColumnIndex: 1,
        ...
        children: [
          Transform(
            ...
            child: FloatingActionButton(
              backgroundColor: Color.fromARGB(255, 58, 8, 143),
          ...
          Transform(
            ...
            child: FloatingActionButton(
              backgroundColor: Color.fromARGB(255, 15, 83, 45),
              onPressed: () {/* Do something */},
              child: const Icon(
                Icons.summarize,
              ),
